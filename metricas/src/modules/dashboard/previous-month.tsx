...
import { UseQueryGetBillingPreviousMonth } from "@/queries/billingQueries";
...
const BillingPreviousMonth = () => {
    const { data, isLoading, error } = UseQueryGetBillingPreviousMonth();

    return (
        <DashboardCard title="Facturación del Mes Anterior" icon={<ChartNoAxesCombined className="w-6 h-6 text-blue-600" />}>
...
export default BillingPreviousMonth;
